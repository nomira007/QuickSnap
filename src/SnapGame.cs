...
namespace CardGames
{
    public class SnapGame
    {
        public static void LoadResources()
        {
			...
			SwinGame.LoadFontNamed ("GameFont", "Chunkfive.otf",12); //setting new font
        }
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.RoyalBlue, "GameFont", 0, 20); //adding new font
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.RoyalBlue,"GameFont", 0, 30); //adding new font
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.RoyalBlue,"GameFont", 0, 40); //adding new font
